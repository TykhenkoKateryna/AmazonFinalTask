...
public class SearchResultPage extends BasePage {
    ...
    public List<WebElement> getSearchResultAppleList() {
        return searchResultAppleListText;
    }

    public List<WebElement> getSearchResultFiveStarsProductsList() {
        return searchResultFiveStarsProductsList;
    }
}
